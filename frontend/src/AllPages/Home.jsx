...
function Home({ user }) {
  ...
  return (
    <div className="container py-5 position-relative">
        ...
        >
          ...
          >
            ...
            <p className="text-muted mb-4">
              Only <span className="fw-semibold">patients</span> can view this
              page.
            </p>
        ...
        <div className="row align-items-center">
          <div className="col-md-6">
            ...
            <p className="mt-3 text-muted">
              Connect with top doctors, chat with our AI assistant for health
              guidance, and access emergency services all in one comprehensive
              platform.
            </p>
        ...
        <section className="py-5">
          <div className="text-center mb-5">
            ...
            <p className="text-muted">
              We combine AI-powered technology with trusted healthcare
              professionals to deliver reliable services for patients, doctors,
              and hospitals.
            </p>
          </div>
          <div className="row g-4">
            <div className="col-md-4">
              <div className="card h-100 shadow-sm border-0 p-4 text-center feature-card">
                ...
                <p className="text-muted">
                  Instant AI guidance for symptoms and preliminary health
                  advice.
                </p>
              </div>
            </div>
            <div className="col-md-4">
              <div className="card h-100 shadow-sm border-0 p-4 text-center feature-card">
                ...
                <p className="text-muted">
                  Connect with verified healthcare specialists in all fields.
                </p>
              </div>
            </div>
            <div className="col-md-4">
              <div className="card h-100 shadow-sm border-0 p-4 text-center feature-card">
                ...
                <p className="text-muted">
                  Request emergency services and ambulance anytime, anywhere.
                </p>
              </div>
            </div>
            <div className="col-md-4">
            ...
            <div className="col-md-4">
              <div className="card h-100 shadow-sm border-0 p-4 text-center feature-card">
                ...
                <p className="text-muted">
                  Search hospitals and clinics near you within seconds.
                </p>
              </div>
            </div>
            <div className="col-md-4">
              <div className="card h-100 shadow-sm border-0 p-4 text-center feature-card">
                ...
                <p className="text-muted">
                  Real patient reviews to help you choose the right doctor.
                </p>
              </div>
            </div>
          </div>
      ...
      {showChat && <ChatWidget />}{" "}
      {/* Only show ChatWidget when showChat state is true */}
    </div>
  );
}
